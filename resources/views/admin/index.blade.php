            ...
            <main class="flex-1 p-10">
                ...
                <div class="max-w-6xl mx-auto px-4 py-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                        ...
                        <!-- Card 2 -->
                        <div
                            class="transition-colors duration-300 p-4 rounded-xl shadow-md bg-white hover:bg-green-100">
                        ...
                        <!-- Card 3 -->
                        <div
                            class="transition-colors duration-300 p-4 rounded-xl shadow-md bg-white hover:bg-yellow-100">
                        ...
                        <!-- Card 4 -->
                        <div
                            class="transition-colors duration-300 p-4 rounded-xl shadow-md bg-white hover:bg-indigo-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <!-- Card 7 -->
                        <div
                            class="transition-colors duration-300 p-4 rounded-xl shadow-md bg-white hover:bg-emerald-100">
