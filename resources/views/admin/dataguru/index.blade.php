                            ...
                            <tbody class="bg-white text-gray-800">
                                @foreach ($gurus as $index => $guru)
                                    <tr class="{{ $loop->even ? 'bg-gray-50' : 'bg-white' }} text-center hover:bg-yellow-50 transition">
                                        ...
                                        <td class="px-4 py-2 border whitespace-nowrap truncate max-w-[120px]" title="{{ $guru->nip }}">{{ $guru->nip }}</td>
                                        ...
                                        <td class="px-4 py-2 border whitespace-nowrap truncate max-w-[150px]" title="{{ $guru->user?->email ?? '-' }}">
                                            {{ $guru->user?->email ?? '-' }}
                                        </td>
                                        ...
                                        <td class="px-4 py-2 border">
                                            <div class="flex justify-center gap-4 text-lg">
                                                ...
                                                <form action="{{ route('admin.dataguru.destroy', $guru->id) }}" method="POST" class="deleteUser" onsubmit="return handleOnClickDelete(event)">
                                                    @csrf @method('DELETE')
