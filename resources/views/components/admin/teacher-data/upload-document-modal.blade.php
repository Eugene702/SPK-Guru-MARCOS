<div 
    ...
    x-init="$watch('data', value => data === null ? $refs.fileUpload.value = null : null)">
    <button class="bg-green-600 text-white px-4 py-2 rounded mb-4 hover:bg-green-700 transition-colors"
            ...
            <div class="px-8 py-6">
                <div class="space-y-6">
                    ...
                    <div class="flex flex-col items-center">
                        <input type="file" class="hidden" id="fileUpload" x-on:change="e => data = e.target.files[0]" x-ref="fileUpload" name="document" />
                        <label for="fileUpload" class="w-full">
                            <div
                                class="bg-blue-500 hover:bg-blue-600 text-white py-3 px-4 rounded-lg transition-all shadow-md flex items-center justify-center cursor-pointer">
                    ...
                    <div class="bg-gray-50 border border-gray-100 rounded-lg p-4 flex items-center" x-show="data">
                        <div
                            class="h-10 w-10 flex-shrink-0 rounded-lg bg-blue-100 flex items-center justify-center mr-3">
                        ...
                        <button type="button" class="ml-4 flex-shrink-0 text-gray-400 hover:text-red-500 focus:outline-none" x-on:click="data = null">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M6 18L18 6M6 6l12 12" />
                            </svg>
