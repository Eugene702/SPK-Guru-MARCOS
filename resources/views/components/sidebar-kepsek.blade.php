...
<div class="bg-sidebar w-64 text-black flex flex-col justify-between">
    <div>
        ...
        <ul class="p-4 space-y-6">
            <li>
                <a href="{{ route('kepsek.index') }}" class="{{ request()->routeIs('kepsek.index') ? 'bg-creamy' : '' }} flex items-center gap-2 hover:bg-creamy hover:text-black px-2 py-2 rounded transition">
